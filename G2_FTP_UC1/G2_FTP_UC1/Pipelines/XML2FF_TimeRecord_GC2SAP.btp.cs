namespace G2_FTP_UC1.Pipelines
{
    ...
    public sealed class XML2FF_TimeRecord_GC2SAP : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"pe=\"xsd:string\">G2_FTP_UC1.XSD.FF_TimeRecord_GC2SAP</Value>            </Property>            <Prope"+
"rty Name=\"TrailerSpecName\" />            <Property Name=\"TargetCharset\">              <Value xsi:typ"+
"e=\"xsd:string\" />            </Property>            <Property Name=\"TargetCodePage\">              <V"+
"alue xsi:type=\"xsd:int\">0</Value>            </Property>            <Property Name=\"PreserveBom\">   "+
"           <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>            <Property N"+
"ame=\"HiddenProperties\">              <Value xsi:type=\"xsd:string\">TargetCodePage</Value>            "+
"</Property>          </Properties>          <CachedDisplayName>Flat file assembler</CachedDisplayNam"+
...
"</Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "22eb1400-03a2-4841-a90f-e63b5e36e527";
        
        public XML2FF_TimeRecord_GC2SAP()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">G2_FTP_UC1.XSD.FF_TimeRe"+
"cord_GC2SAP</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"TargetC"+
"harset\">      <Value xsi:type=\"xsd:string\" />    </Property>    <Property Name=\"TargetCodePage\">    "+
"  <Value xsi:type=\"xsd:int\">0</Value>    </Property>    <Property Name=\"PreserveBom\">      <Value xs"+
"i:type=\"xsd:boolean\">false</Value>    </Property>    <Property Name=\"HiddenProperties\">      <Value "+
"xsi:type=\"xsd:string\">TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
