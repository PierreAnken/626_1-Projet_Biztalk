namespace G2_FTP_UC1.Pipelines
{
    ...
    public sealed class FF2XML_EmergencyMode_EG2GC : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"       <Value xsi:type=\"xsd:string\">G2_FTP_UC1.XSD.FF_EmergencyMode_EG2GC</Value>            </Prope"+
...
"0e-4cce-4536-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "7c374710-43f3-47a1-b80e-6835a486c6ad";
        
        public FF2XML_EmergencyMode_EG2GC()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">G2_FTP_UC1.XSD.FF_Emerge"+
"ncyMode_EG2GC</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"Prese"+
